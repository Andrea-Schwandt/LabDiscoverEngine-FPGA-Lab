...
class Config(object):
    ...
    WEBLAB_CALLBACK_URL = '/c_x_lab/callback'
    SESSION_COOKIE_NAME = 'c_x_lab'
    SESSION_COOKIE_PATH = '/'
    WEBLAB_SESSION_ID_NAME = 'c_x_lab'
    WEBLAB_REDIS_BASE = 'c_x_lab'
    #UPLOAD_FOLDER = 'http://10.30.200.157/labfiles/uploads'
